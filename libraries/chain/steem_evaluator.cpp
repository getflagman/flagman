...
namespace golos { namespace chain {
    ...
    std::string get_balance_name(balance_type type) {
        ...
        void account_create_evaluator::do_apply(const account_create_operation &o) {
            ...
            if (nullptr != _db.find_account(o.new_account_name)) {
                GOLOS_THROW_OBJECT_ALREADY_EXIST("account", o.new_account_name);
            }
...
/// this loop can be skiped for validate-only nodes as it is merely gathering stats for indicies
        ...
        void convert_evaluator::do_apply(const convert_operation &o) {
            ...
            if (nullptr != _db.find<convert_request_object,by_owner>(boost::make_tuple(o.owner, o.requestid))) {
                GOLOS_THROW_OBJECT_ALREADY_EXIST("convert_request", fc::mutable_variant_object()("account",o.owner)("request_id",o.requestid));
            }
        ...
        void limit_order_create_evaluator::do_apply(const limit_order_create_operation &o) {
            ...
            if (nullptr != _db.find_limit_order(o.owner, o.orderid)) {
                GOLOS_THROW_OBJECT_ALREADY_EXIST("limit_order", fc::mutable_variant_object()("account",o.owner)("order_id",o.orderid));
            }
