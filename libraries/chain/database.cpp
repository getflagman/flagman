            ...
            try {
                ...
                if (comment.net_rshares > 0) {
                    ...
                    if (reward_tokens > 0) {
                        ...
                        push_virtual_operation(author_reward_operation(comment.author, to_string(comment.permlink), sbd_payout.first, sbd_payout.second, vest_created, author_tokens), true);
                ...
                push_virtual_operation(comment_payout_update_operation(comment.author, to_string(comment.permlink),
                    total_payout_value, curator_payout_value, beneficiary_payout_value), true);
